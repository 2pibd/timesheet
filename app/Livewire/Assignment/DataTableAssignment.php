...
class DataTableAssignment extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        if (!empty($this->search)) {
            $query->where('consultent_id', 'like', '%' . $this->search . '%')
                ->orWhere('personal_ref', 'like', '%' . $this->search . '%');
        }
        ...
        return view('livewire.assignment.data-table-assignment'  ,   [ 'data' => $data  ]);
