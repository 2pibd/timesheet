...
class DataTableEmailTemplate extends Component
{
    use WithPagination;
    ...
    public function render()
    {
     ...
     \Log::info('Livewire Query', [
        ...
        return view('livewire.data-table-email-template',   [ 'data' => $data  ]);
    }
    ...
    public function exportToPDF(Request $request){
        ...
        $pdf = Pdf::loadView('admin.email_template.export', compact('data'));
