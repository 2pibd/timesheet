...
namespace App\Livewire\EscalationFrequency;
...
class DataTableEscalationFrequency extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $query = escalation_frequency::query();
        ...
        return view('livewire.escalation-frequency.data-table-escalation-frequency', [ 'data' => $data  ]);
    ...
    public function exportToExcel(Request $request)
    {
        ...
        return Excel::download(new EmailTemplateExport($filters), time().'_escalation_frequency.xlsx');
    }


    public function exportToPDF(Request $request){

        $data = escalation_frequency::all(); // Fetch all data
        $pdf = Pdf::loadView('admin.escalation_frequency.export', compact('data'));

        // Return PDF download response
        return response()->streamDownload(
            fn () => print($pdf->output()),
            time().'_escalation_frequency.pdf'
        );
    }
    ...
    public function printContent()
    {
        ...
        $this->dispatch('print-escalation_frequency');
    }
