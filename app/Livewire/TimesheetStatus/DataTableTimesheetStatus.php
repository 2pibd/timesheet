...
namespace App\Livewire\TimesheetStatus;
...
class DataTableTimesheetStatus extends Component
{
    use WithPagination;
    ...
    public $sortField = 'code'; // Default sort field
    ...
    public function render()
    {
        ...
        return view('livewire.timesheet-status.data-table-timesheet-status',   [ 'data' => $data  ]);
    ...
    public function exportToExcel(Request $request)
    {
        ...
        return Excel::download(new EmailTemplateExport($filters), time().'_timesheet_status.xlsx');
    }


    public function exportToPDF(Request $request){

        $data = timesheet_status::all(); // Fetch all data
        $pdf = Pdf::loadView('admin.timesheet_status.export', compact('data'));

        // Return PDF download response
        return response()->streamDownload(
            fn () => print($pdf->output()),
            time().'_timesheet_status.pdf'
        );
    }
    ...
    public function printContent()
    {
        ...
        $this->dispatch('print-timesheet_status');
    }
