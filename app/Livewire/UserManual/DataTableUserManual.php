...
class DataTableUserManual extends Component
{
    use WithPagination;
...
/*        \Log::info('Livewire Query', [
        ...
        return view('livewire.user-manual.data-table-user-manual' , [ 'data' => $data  ]);
    ...
    public function exportToExcel(Request $request)
    {
        ...
        return Excel::download(new EmailTemplateExport($filters), time().'_user_manual.xlsx');
    }


    public function exportToPDF(Request $request){

        $data = user_manual::all(); // Fetch all data
        $pdf = Pdf::loadView('admin.user_manual.export', compact('data'));

        // Return PDF download response
        return response()->streamDownload(
            fn () => print($pdf->output()),
            time().'_user_manual.pdf'
        );
    }
    ...
    public function printContent()
    {
        ...
        $this->dispatch('print-user_manual');
    }
