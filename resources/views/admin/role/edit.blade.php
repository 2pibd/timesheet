            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12 table-responsive">
                        <form class="bs-example" action="{{ route('role.update', $role->id) }}"
                              method="post">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
                                <table class="table table-bordered">
                                        ...
                                        <td>
                                            <select class="form-select" name="user_role_group_id" id="user_role_group_id" required>
                                                @foreach($user_role_group as $key=>$value)
                                                    <option value="{{$value->id}}" @if($role->user_role_group_id == $value->id) selected="selected" @endif >{{$value->group_name}}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" name="sort_access_no" placeholder="Role Sort Order" type="number"
