...
<form method="POST" action="{{ route('save_setting') }}" id="form_restful_api" class="mt-6 space-y-6"
...
<script>
    ...
    $(function () {
        var form_restful_api = $('#form_srestful_api');

        form_restful_api.submit(function (event) {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'JSON',
                data: form_restful_api.serialize(),
