            ...
            <ul class="dropdown-menu" aria-labelledby="columnVisibilityDropdown">
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colOffice_manager" checked onclick="toggleColumn('office_manager')"> Name
                    </label>
                </li>
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colClient_id" checked onclick="toggleColumn('client_id')"> Client Name
                    </label>
                </li>
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colParsonal_ref" checked onclick="toggleColumn('parsonal_ref')"> Assignment No.
                    </label>
                </li>

                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colTs_authoriser" checked onclick="toggleColumn('ts_authoriser')"> Authorizer
                    </label>
                </li>
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colOnline" checked onclick="toggleColumn('online')"> Online Auth
                    </label>
                </li>

                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colOnline_expences" checked onclick="toggleColumn('online_expences')"> Online TS Type
                    </label>
                </li>

                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colActual_end_date" checked onclick="toggleColumn('actual_end_date')"> Actual Timesheets
                    </label>
                </li>
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colExpected_end_date" checked onclick="toggleColumn('expected_end_date')"> Expected Timesheets
                    </label>
                </li>
            ...
            <tr>
                ...
                <th data-column="client_group_id">
                    <button wire:click="sortBy('client_group_id')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Assignment No</span>
                        <span class="sort-icons">
                ...
                <th  data-column="address">
                    <button wire:click="sortBy('address')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Authorizer</span>
                        <span class="sort-icons">
                ...
                <th  data-column="company_phone">
                    ...
                    <button wire:click="sortBy('contact_number')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Online Auth</span>
                        <span class="sort-icons">
                ...
                <th  data-column="postcode">
                    <button wire:click="sortBy('address_line1')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Online Access</span>
                        <span class="sort-icons">
                ...
                <th  data-column="post_code">
                    <button wire:click="sortBy('post_code')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Online TS Type</span>
                        <span class="sort-icons">
                ...
                <th  data-column="post_code">
                    <button wire:click="sortBy('post_code')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Actual Timesheets</span>
                        <span class="sort-icons">
                       <i class="fa fa-sort-up {{ $sortField === 'post_code' && $sortDirection === 'asc' ? 'active-icon' : 'light-icon' }}"></i>
                       <i class="fa fa-sort-down {{ $sortField === 'post_code' && $sortDirection === 'desc' ? 'active-icon' : 'light-icon' }}"></i>
                    </span>
                ...
                <th  data-column="post_code">
                    <button wire:click="sortBy('post_code')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Expected Timesheets</span>
                        <span class="sort-icons">
                       <i class="fa fa-sort-up {{ $sortField === 'post_code' && $sortDirection === 'asc' ? 'active-icon' : 'light-icon' }}"></i>
                       <i class="fa fa-sort-down {{ $sortField === 'post_code' && $sortDirection === 'desc' ? 'active-icon' : 'light-icon' }}"></i>
                    </span>
