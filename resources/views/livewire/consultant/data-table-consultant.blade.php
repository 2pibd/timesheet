            ...
            <tr>
                ...
                <th data-column="company_name">
                    <button wire:click="sortBy('name')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Office Manager</span>
                ...
                <th  data-column="postcode">
                    <button wire:click="sortBy('consultant_code')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Consultant Code</span>
                        <span class="sort-icons">
                       <i class="fa fa-sort-up {{ $sortField === 'consultant_code' && $sortDirection === 'asc' ? 'active-icon' : 'light-icon' }}"></i>
                       <i class="fa fa-sort-down {{ $sortField === 'consultant_code' && $sortDirection === 'desc' ? 'active-icon' : 'light-icon' }}"></i>
                    </span>
                    </button>
                </th>
