            ...
            <ul class="dropdown-menu" aria-labelledby="columnVisibilityDropdown">
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colCompany_name" checked onclick="toggleColumn('company_name')"> Client Name
                    </label>
                </li>
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colExternal_ref" checked onclick="toggleColumn('external_ref')"> Client Ref
                    </label>
                </li>
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colClient_group_id" checked onclick="toggleColumn('client_group_id')"> Client Group ID
                    </label>
                </li>
                <li>
                    <label class="dropdown-item">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <th data-column="company_name">
                    <button wire:click="sortBy('worker_id')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Worker</span>
                        <span class="sort-icons">
                       <i class="fa fa-sort-up {{ $sortField === 'worker_id' && $sortDirection === 'asc' ? 'active-icon' : 'light-icon' }}"></i>
                       <i class="fa fa-sort-down {{ $sortField === 'worker_id' && $sortDirection === 'desc' ? 'active-icon' : 'light-icon' }}"></i>
                    </span>
                    </button>
                </th>
                <th  data-column="external_ref">

                    <button wire:click="sortBy('timesheet_number')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Timesheet Number</span>
                        <span class="sort-icons">
                       <i class="fa fa-sort-up {{ $sortField === 'timesheet_number' && $sortDirection === 'asc' ? 'active-icon' : 'light-icon' }}"></i>
                       <i class="fa fa-sort-down {{ $sortField === 'timesheet_number' && $sortDirection === 'desc' ? 'active-icon' : 'light-icon' }}"></i>
                    </span>
                    </button>
                </th>
                ...
                <th  data-column="postcode">
                    <button wire:click="sortBy('postcode')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Total Pay</span>
                        <span class="sort-icons">
                       <i class="fa fa-sort-up {{ $sortField === 'postcode' && $sortDirection === 'asc' ? 'active-icon' : 'light-icon' }}"></i>
                       <i class="fa fa-sort-down {{ $sortField === 'postcode' && $sortDirection === 'desc' ? 'active-icon' : 'light-icon' }}"></i>
                    </span>
                    </button>
                </th>
                ...
                <th  data-column="postcode">
                    <button wire:click="sortBy('postcode')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Total Charge</span>
                        <span class="sort-icons">
                       <i class="fa fa-sort-up {{ $sortField === 'postcode' && $sortDirection === 'asc' ? 'active-icon' : 'light-icon' }}"></i>
                       <i class="fa fa-sort-down {{ $sortField === 'postcode' && $sortDirection === 'desc' ? 'active-icon' : 'light-icon' }}"></i>
                    </span>
                ...
                <th  data-column="postcode">
                    <button wire:click="sortBy('postcode')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Tax Year/Period</span>
                        <span class="sort-icons">
                       <i class="fa fa-sort-up {{ $sortField === 'postcode' && $sortDirection === 'asc' ? 'active-icon' : 'light-icon' }}"></i>
                       <i class="fa fa-sort-down {{ $sortField === 'postcode' && $sortDirection === 'desc' ? 'active-icon' : 'light-icon' }}"></i>
                    </span>
                ...
                <th  data-column="postcode">
                    <button wire:click="sortBy('postcode')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">Release Date</span>
                        <span class="sort-icons">
                       <i class="fa fa-sort-up {{ $sortField === 'postcode' && $sortDirection === 'asc' ? 'active-icon' : 'light-icon' }}"></i>
                       <i class="fa fa-sort-down {{ $sortField === 'postcode' && $sortDirection === 'desc' ? 'active-icon' : 'light-icon' }}"></i>
                    </span>
            ...
            @forelse ($data as $item)
                <tr>
                    ...
                    <td data-column="worker_id">{{ $item->worker_id }}</td>
                    <td data-column="timesheet_number">{{ $item->timesheet_number }}</td>
                    <td data-column="status">{{ $item->status ?? '' }}</td>
                    <td data-column="timesheet_date">{{ $item->timesheet_date ?? '' }}</td>
                    <td data-column="client_ref">{{ $item->client_ref ?? '' }}</td>
                    <td data-column="total_pay">{{ $item->total_pay ?? '' }}</td>
                    <td data-column="total_charge">{{ $item->total_charge ?? '' }}</td>
                    <td data-column="invoice_no">{{ $item->invoice_no ?? '' }}</td>
                    <td data-column="total_pay">{{ $item->tax_year ?? '' }}</td>
                    <td data-column="total_pay">{{ $item->release_date ?? '' }}</td>
                            ...
                            <li class="list-inline-item no-print">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        @can('view-timesheet')
                                            <li><a href="{{ route('timesheet.show', $item->id) }}" class="dropdown-item view-item-btn"
                                                   title="View"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                        @endcan
                                        @can('update-timesheet')
                                            <li><a href="{{ route('timesheet.edit', $item->id) }}" class="dropdown-item edit-item-btn"
                                        ...
                                        @can('delete-timesheet')
                                            <li>
                                                <form method="POST" action="{{ route('timesheet.destroy', $item->id) }}"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        Livewire.on('print-timesheet', function () {
