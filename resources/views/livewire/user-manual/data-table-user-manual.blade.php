    ...
    <div class="d-flex mb-3" >
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="columnVisibilityDropdown">
                ...
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colName" checked onclick="toggleColumn('name')"> Description
                    </label>
                </li>
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input" id="colUser_ref" checked onclick="toggleColumn('user_ref')"> File Name
                    </label>
                </li>
    ...
    <div class="table-bordered table-responsive printable-section">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <th data-column="client">
                    <span class="text-start">Supplier</span>
                </th>
                <th data-column="client">
                    <span class="text-start">Consultant</span>
                </th>
                ...
                <th  data-column="address">
                    <button wire:click="sortBy('address')" class="btn btn-link p-0 d-flex justify-content-between align-items-center w-100">
                        <span class="text-start">File Name</span>
                        <span class="sort-icons">
            ...
            @forelse ($data as $item)
                <tr>
                    ...
                    <td data-column="consultant">
                        <input class="form-check-input updateFlag" data-area="consultant" data-id="{{$item->id}}" type="checkbox"  @if(isset($item->consultant) && $item->client==1) checked @endif>

                      </td>
                    <td data-column="company_phone">{{ $item->file ?? '' }}</td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        @can('view-user_manual')
                                            <li><a href="{{ route('user_manual.show', $item->id) }}" class="dropdown-item view-item-btn"
                                                   title="View"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                        @endcan
                                        @can('update-user_manual')
                                            <li><a href="{{ route('user_manual.edit', $item->id) }}" class="dropdown-item edit-item-btn"
                                        ...
                                        @can('delete-user_manual')
                                            <li>
                                                <form method="POST" action="{{ route('user_manual.destroy', $item->id) }}"
    ...
    <script>
        ...
        $(function () {
            ...
            $(document).on('click', '.updateFlag', function () {
                ...
                $.ajax({
                    url: "{{URL::to('admin/update-user-manual')}}",
                    dataType: "JSON",
                    type: 'POST',
